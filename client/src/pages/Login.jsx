  ...
  return (
    ...
    sm:w-96 text-indigo-300 text-sm">
      ...
      <form >
        ...
        {state === 'Sign Up'&& (<div className="mb-4 flex items-center gap-3 w-full 
        ...
        px-5 py-2.5 rounded-full bg-[#333A5C] ">
          ...
          <input  className=" bg-transparent outline-none text-white"type="text" placeholder="password"  required/>
        </div>
