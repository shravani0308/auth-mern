    ...
    sm:px-24 absolute top-0'>
      ...
      text-white relative group'>
       ...
       <ul className='list-none m-0 p-2 bg-gray-100 text-sm'>
        {!userData.isAccountVerified &&         <li onClick={sendVerificationOtp} className='py-1 px-2 hover:bg-gray-200 text-sm cursor-pointer'>Verify email</li>}
        <li onClick={logout}
         className='py-1 px-2 hover:bg-gray-200 text-sm cursor-pointer pr-10'>Logout</li>
